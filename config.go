...
func flagsSetup() {
	...
	flag.IntVar(&Config.NumWorkers, "num", 2, "number of workers")
	flag.IntVar(&Config.NumWorkers, "n", 2, "number of workers")
	flag.IntVar(&Config.NumFetches, "numfetches", 2, "number of redis fetches in one go")
	flag.StringVar(&fetchpoll, "time", "5s", "time interval in seconds of polling redis")
	flag.StringVar(&Config.SERVER_IP, "ip", "10.146.20.220", "ip address of the host")
